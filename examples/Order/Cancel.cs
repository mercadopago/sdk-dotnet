...
internal class CancelOrderExample
{
    private static void Main(string[] args)
    {
        ...
        Order canceledOrder = client.Cancel(order.Id);
        Console.WriteLine(Newtonsoft.Json.JsonConvert.SerializeObject(canceledOrder, Newtonsoft.Json.Formatting.Indented));
    }
}
