...
internal class CaptureOrderExample
{
    private static void Main(string[] args)
    {
        ...
        Order capturedOrder = client.Capture(order.Id);
        Console.WriteLine(Newtonsoft.Json.JsonConvert.SerializeObject(capturedOrder, Newtonsoft.Json.Formatting.Indented));
    }
}
