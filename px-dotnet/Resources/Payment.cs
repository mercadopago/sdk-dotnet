...
namespace MercadoPago.Resources
{
    public class Payment : MPBase
    {
        ...
        {
            return (Payment)ProcessMethod<Payment>(typeof(Payment), "FindById", id, false);
        }
        ...
        /// </summary>
        [GETEndpoint("/v1/payments/:id")]
        public static Payment FindById(string id, bool useCache)
        {
            return (Payment)ProcessMethod<Payment>(typeof(Payment), "FindById", id, useCache);
        }
